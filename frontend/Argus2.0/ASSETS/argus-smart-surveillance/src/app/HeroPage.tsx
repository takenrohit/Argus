...
export default function HeroPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 bg-[url('data:image/svg+xml;base64,')] opacity-50 pointer-events-none" />
